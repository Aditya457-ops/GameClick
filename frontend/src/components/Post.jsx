...
const Post = ({ username, image, title, caption, postId, profile, likers, userId }) => {
  ...
  return (
      <div className="w-[250px] h-[350px] rounded-xl overflow-hidden flex flex-col shadow-md m-5">
        {/* Fixed-size Image */}
        <div className="relative w-full h-[220px] bg-[#DEDEDE]">
          <img 
            src={image} 
            alt="photo" 
            className="w-full h-full object-cover"  // keeps aspect ratio but fills box
          />
        ...
        {/* Fixed-size Content */}
        <div className="bg-white w-full h-[130px] p-3 flex flex-col justify-between">
          <div>
